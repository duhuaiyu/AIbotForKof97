...
def index_to_attack_action(action):
    return {
        ...
        6: [Actions.P1_A, Actions.P1_B, Actions.P1_C, Actions.P1_D],
        7: []
    }[action]
...
class Kof97Environment(object):
    ...
    def check_done(self, data):
        print("fighting", data["fighting"], 'healthP1', data["healthP1"],'healthP2', data["healthP2"])
        # if data["fighting"] == 0:
