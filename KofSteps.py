...
def set_difficulty(frame_ratio, difficulty):
    steps = [
        ...
        {"wait": int(10 / frame_ratio), "actions": [Actions.P1_DOWN]},
        {"wait": int(10 / frame_ratio), "actions": [Actions.P1_A]},
        {"wait": int(10 / frame_ratio), "actions": [Actions.P1_C]},
        {"wait": int(10 / frame_ratio), "actions": [Actions.P1_C]},
        {"wait": int(10 / frame_ratio), "actions": [Actions.P1_DOWN]},
        {"wait": int(10 / frame_ratio), "actions": [Actions.P1_DOWN]},
        {"wait": int(10 / frame_ratio), "actions": [Actions.P1_DOWN]},
...
def start_game(frame_ratio):
    return [
        ...
        {"wait": int(600/frame_ratio), "actions": [Actions.P1_A]},
        {"wait": int(300 / frame_ratio), "actions": [Actions.P1_A]},
        {"wait": int(50 / frame_ratio), "actions": [Actions.P1_RIGHT]},
        {"wait": int(50 / frame_ratio), "actions": [Actions.P1_RIGHT]},
        {"wait": int(50 / frame_ratio), "actions": [Actions.P1_RIGHT]},
        {"wait": int(50 / frame_ratio), "actions": [Actions.P1_RIGHT]},
        {"wait": int(50 / frame_ratio), "actions": [Actions.P1_DOWN]},
        {"wait": int(50 / frame_ratio), "actions": [Actions.P1_DOWN]},
        {"wait": int(50 / frame_ratio), "actions": [Actions.P1_DOWN]},
        {"wait": int(300/frame_ratio), "actions": [Actions.P1_A]},
        {"wait": int(300/frame_ratio), "actions": [Actions.P1_A]}]
...
def next_stage(frame_ratio):
    return [
        {"wait": int(50/frame_ratio), "actions": []},
        {"wait": int(10/frame_ratio), "actions": [Actions.P1_A]},
        {"wait": int(50 / frame_ratio), "actions": []},
        {"wait": int(10 / frame_ratio), "actions": [Actions.P1_A]},
        {"wait": int(50 / frame_ratio), "actions": []},
